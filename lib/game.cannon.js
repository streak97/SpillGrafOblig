...
window.game.cannon = function () {
    var _cannon = {
        ...
        getCollided: function (index) {
            //Returns index of collided body

            for (var i = 0; i < _cannon.world.collisionMatrix.length; i++) {
                if (_cannon.world.collisionMatrix[i] && _cannon.world.collisionMatrix[i].length && (_cannon.world.collisionMatrix[i][0] === index || _cannon.world.collisionMatrix[i][1] === index)) {
                    if (_cannon.world.collisionMatrix[i][0] === index) {
                        return _cannon.world.collisionMatrix[i][1];
                    } else {
                        return _cannon.world.collisionMatrix[i][0];
                    }
                }
            }
        ...
        updatePhysics: function (delta) {
            ...
            let body = _cannon.bodies[0], visual = _cannon.visuals[0];
            ...
            _cannon.world.step(_cannon.timestep, delta, 10);
        },
